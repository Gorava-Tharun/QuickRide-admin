...
class FirestoreComplaintReplyModel {
  ...
  factory FirestoreComplaintReplyModel.fromMap(Map<String, dynamic> map, {String? id}) =>
      FirestoreComplaintReplyModel(
        ...
        senderRole: (map['senderRole'] as String? ?? 'ADMIN').toUpperCase(),
        message: map['message'] as String? ?? '',
        createdAt: _parseSharedDateTime(map['createdAt']) ?? DateTime.now(),
      );

  bool get isAdmin => senderRole.toUpperCase() == 'ADMIN';
  bool get isUser => senderRole.toUpperCase() == 'USER';
  bool get isCaptain => senderRole.toUpperCase() == 'CAPTAIN';
}
...
class FirestoreNotificationModel {
  ...
  final String recipientRole; // 'user', 'captain', or 'admin'
  final String? userId;
  final String? captainId;
  final String? rideId;
  final String? complaintId;
  ...
  const FirestoreNotificationModel({
    ...
    required this.createdAt,
    this.data,
  })  : recipientId = recipientId ?? (userId ?? captainId ?? 'admin_all'),
  ...
  factory FirestoreNotificationModel.fromMap(Map<String, dynamic> map, {String? id}) {
    ...
    final rId = map['recipientId'] as String? ?? (uId ?? cId ?? 'admin_all');
